  ...
  return (
    <section class="w-1/4 max-w-72 flex flex-col items-center border-r-2 h-screen shadow-lg text-left text-lg xl:text-2xl">
      ...
      <div class="flex flex-col items-start mx-10">
        ...
        <button class="self-center w-full text-2xl bg-[#00539F] p-1 text-white rounded-xl mt-3 hover:shadow-lg hover:mt-2 transition-all duration-300 hover:bg-blue-500">Search</button>
      </div>
    </section>
  );
}
